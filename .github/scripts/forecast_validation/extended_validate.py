...
from validate_extras import run_extra_checks
...
def run ():
    ...
    for elem in to_validate:
        ...
        try:
            ...
            # 2) nuovi controlli (settimana/anno vs filename, duplicati, monotonia quantili)
            extra_errors = run_extra_checks(elem)
